...
class PHPStanDocblockParserFactoryTest extends IntegrationTestCase
{
    ...
    public function provideResolveType(): Generator
    {
        ...
        yield 'parenthesized complex' => [
            '/** @return (Type1&Type2)|Type3 */',
      new UnionType(
          new IntersectionType(new ClassType(ClassName::fromString('Type1')), new ClassType(ClassName::fromString('Type2'))),
          new ClassType(ClassName::fromString('Type3'))
      )
        ];
    }
    ...
    private function parseDocblockWithReflector(Reflector $reflector, string $docblock): DocBlock
    {
        ...
        return (new PHPStanDocblockParserFactory($reflector))->create($docblock, $scope->reveal());
    }

    private function parseDocblockWithClass(Reflector $reflector, ReflectionClassLike $classLike, string $docblock): DocBlock
    {
        return (new PHPStanDocblockParserFactory($reflector))->create($docblock, $classLike->scope());
    }
}
