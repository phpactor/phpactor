...
class GenerateMutatorsCommand implements Command
{
    public const NAME  = 'generate_mutators';

    private GenerateMutator $generateMutator;
    ...
    public function __invoke(string $uri, int $startOffset, array $propertyNames): Promise
    {
        ...
        try {
            $textEdits = $this->generateMutator->generate(
