...
class GenerateMutatorsProvider implements CodeActionProvider
{
    public const KIND = 'quickfix.generate_mutators';
        ...
        return call(function () use ($range, $textDocument) {
            ...
            return [
                CodeAction::fromArray([
                    'title' => sprintf('Generate %s mutator(s)', count($propertyNames)),
                    'kind' => self::KIND,
                    'command' => new Command(
                        sprintf('Generate %s mutator(s)', count($propertyNames)),
